...
<section class="blog section">
	...
	<a href="" class="btn btn-transparent">Read More</a>
				...
				<article>
					<div class="post-slider owl-carousel owl-theme">
					  <div class="item"><img src="<?php echo base_url();?>assets/images/blog/post-2.jpg" alt="Slider-Img-01"></div>
					  <div class="item"><img src="<?php echo base_url();?>assets/images/blog/post-2.jpg" alt="Slider-Img-02"></div>
					  <div class="item"><img src="<?php echo base_url();?>assets/images/blog/post-2.jpg" alt="Slider-Img-03"></div>
					</div>
					<h3>Donec id dolor in erat imperdiet.</h3>
					<ul class="list-inline">
						<li class="list-inline-item">by <a href="">Admin</a></li>
	...
	<!-- Post Image -->
	<div class="image">
		<img src="<?php echo base_url();?>assets/images/blog/post-4.jpg" alt="article-01">
	</div>
	<!-- Post Title -->
	<h3>Donec id dolor in erat imperdiet.</h3>
	<ul class="list-inline">
	...
	<!-- Post Image -->
	<div class="image">
		<img src="<?php echo base_url();?>assets/images/blog/post-5.jpg" alt="article-01">
	</div>
	<!-- Post Title -->
	<h3>Donec id dolor in erat imperdiet.</h3>
	<ul class="list-inline">
					...
					<div class="widget related-store">
						...
						<ul class="store-list md list-inline">
							<li class="list-inline-item">
								<a href=""><img src="<?php echo base_url();?>assets/images/popular-offer/populer-offer-02.png" alt="store-image"></a>
							</li>
							<li class="list-inline-item">
								<a href=""><img src="<?php echo base_url();?>assets/images/popular-offer/populer-offer-03.png" alt="store-image"></a>
							</li>
							<li class="list-inline-item">
								<a href=""><img src="<?php echo base_url();?>assets/images/popular-offer/populer-offer-04.png" alt="store-image"></a>
							</li>
							<li class="list-inline-item">
								<a href=""><img src="<?php echo base_url();?>assets/images/popular-offer/populer-offer-05.png" alt="store-image"></a>
							</li>
							<li class="list-inline-item">
								<a href=""><img src="<?php echo base_url();?>assets/images/popular-offer/populer-offer-06.png" alt="store-image"></a>
							</li>
							<li class="list-inline-item">
								<a href=""><img src="<?php echo base_url();?>assets/images/popular-offer/populer-offer-07.png" alt="store-image"></a>
							</li>
						</ul>
					</div>
					<!-- Archive Widget -->
