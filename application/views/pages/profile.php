					...
					<div id="carouselExampleIndicators" class="product-slider carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100" src="<?php echo base_url();?>assets/images/products/products-1.jpg" alt="First slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="<?php echo base_url();?>assets/images/products/products-2.jpg" alt="Second slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="<?php echo base_url();?>assets/images/products/products-3.jpg" alt="Third slide">
							</div>
						</div>
			...
			<div class="col-md-4">
				<div class="sidebar">
					...
					<div class="widget user">
						<img class="rounded-circle" src="<?php echo base_url();?>assets/images/user/user-thumb.jpg" alt="">
